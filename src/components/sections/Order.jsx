    ...
    <section className="section_order" id="order">
      ...
      <div className="order_wrapper">
        ...
        <div className="wrapper_btn">
          <a href='https://t.me/kristina_akdemir' className='order telegram'><span>Оформить заказ через</span><img src={telegram} alt="telegram" /></a>
          <p>или</p>
          <a className='order whatsapp'><span>Оформить заказ через</span><img src={whatsapp} alt="whatsapp" /></a>
        </div>
      </div>
    </section>
  );
